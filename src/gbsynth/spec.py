...
class Flag(BaseModel):
    """A custom feature flag declared by a vertical (beyond the generated catalog).

    Used e.g. by the AI vertical to ship JSON-valued model/prompt-config flags. The
    generic catalog (kill switches, rollout, targeting, stale, experiment-refs) is
    generated by the provisioner regardless.
    """
